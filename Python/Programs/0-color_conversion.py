# Python script to convert a given hex #FFFFFF and converts it to rgb(255, 255, 255), and vice-versa.
...
def value_is_valid(value: str | int, test_mode: str):
    match test_mode:
        case "length": # Input cannot be like #9999999123
            return len(str(value)) in [HEX_MIN_LEN, HEX_MAX_LEN]
        case "color": # Input cannot be over 255
            return value in range(MAX_COLOR + INCLUSIVE)
